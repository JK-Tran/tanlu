...
abstract class $AttendanceStudentCopyWith<$Res> {
  factory $AttendanceStudentCopyWith(
    ...
    $Res Function(AttendanceStudent) then,
...
abstract class _$$AttendanceStudentImplCopyWith<$Res>
    implements $AttendanceStudentCopyWith<$Res> {
  factory _$$AttendanceStudentImplCopyWith(
    _$AttendanceStudentImpl value,
...
class __$$AttendanceStudentImplCopyWithImpl<$Res>
  ...
  __$$AttendanceStudentImplCopyWithImpl(
    _$AttendanceStudentImpl _value,
...
class _$AttendanceStudentImpl implements _AttendanceStudent {
  ...
  @override
  String toString() {
    return 'AttendanceStudent(studentId: $studentId, studentCode: $studentCode, fullName: $fullName, nickName: $nickName, avatarUrl: $avatarUrl, status: $status, isExcused: $isExcused, note: $note, checkInTime: $checkInTime, checkOutTime: $checkOutTime, leaveRequest: $leaveRequest)';
  }
