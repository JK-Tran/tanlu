...
class _$GetStudentsOutputImpl extends _GetStudentsOutput {
  const _$GetStudentsOutputImpl(final List<Student> students)
    : _students = students,
      super._();
...
abstract class _GetStudentsOutput extends GetStudentsOutput {
  const factory _GetStudentsOutput(final List<Student> students) =
      _$GetStudentsOutputImpl;
  const _GetStudentsOutput._() : super._();
