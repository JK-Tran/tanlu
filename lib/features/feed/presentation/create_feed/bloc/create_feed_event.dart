...
@freezed
class CreateFeedMediaPicked extends CreateFeedEvent
    with _$CreateFeedMediaPicked {
  const factory CreateFeedMediaPicked({
    required List<CreateFeedLocalMedia> items,
