...
abstract final class IosFeedMediaPicker {
    ...
    try {
      final assets = await AssetPicker.pickAssets(
        ...
        pickerConfig: AssetPickerConfig(
          ...
          selectPredicate: (pickerContext, asset, isSelected) =>
              _onSelectAsset(
            pickerContext,
            asset: asset,
  ...
  static Future<bool> _onSelectAsset(
    ...
    final imageCount =
        selected.where((item) => item.type == AssetType.image).length;
    final videoCount =
        selected.where((item) => item.type == AssetType.video).length;
